...
AlgGeom::DrawOctree::DrawOctree(Octree& oct, bool triangles) : Model3D()
{
    Component* component = new Component;

    std::vector<Octree::Node*> nodes = oct.getLeafNodes();
    
    if (triangles) // CON TRIANGULOS
    {
...
AlgGeom::DrawOctree::DrawOctree(std::vector<Octree::Node*>& nodes, bool triangles) : Model3D()
{
    Component* component = new Component;
